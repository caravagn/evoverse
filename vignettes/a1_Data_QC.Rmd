...
* pipeline parameters, which allow to:
   ...
   * decide if input segments should be [smoothed by CNAqc](https://caravagn.github.io/CNAqcarticles/a5_smoothing.html), `smooth`;
   * decide how peaks  should be [matched by CNAqc](https://caravagn.github.io/CNAqc/articles/a3_peaks_detection.html), `matching_epsilon_peaks`;
...
```{r, fig.width=15, fig.height=16.5, eval=TRUE}
plot(pipeline)
```
